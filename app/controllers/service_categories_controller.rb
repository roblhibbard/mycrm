class ServiceCategoriesController < ApplicationController
  ...
  def index
    @service_categories = ServiceCategorie.all
  end
  ...
  def new
    @service_category = ServiceCategorie.new
  end
  ...
  def create
    @service_category = ServiceCategorie.new(service_category_params)

    respond_to do |format|
      if @service_category.save
        format.html { redirect_to @service_category, notice: 'Service categorie was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @service_category.update(service_category_params)
        format.html { redirect_to @service_category, notice: 'Service categorie was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to service_categories_url, notice: 'Service categorie was successfully destroyed.' }
  ...
  private
    ...
    def set_service_category
      @service_category = ServiceCategorie.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def service_category_params
      params.require(:service_category).permit(:name, :sub_category_id)
    end
end
